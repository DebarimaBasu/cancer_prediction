...
const MetricsCard = ({
  ...
  <div className="flex flex-col rounded-xl border bg-[#17171e] shadow-sm dark:border-neutral-800 dark:bg-[#13131a] border-green-600">
    ...
    <a
      className="inline-flex items-center justify-between rounded-b-xl border border-green-600 px-4 py-3 text-sm text-gray-600 hover:bg-green-100 md:px-5 dark:border-neutral-800 dark:text-neutral-400 dark:hover:bg-neutral-800"
      href="#"
      onClick={onClick}
    >
      {subtitle}
